...
sealed interface Event {
    ...
    data object SessionCreated: Event {
        ...
        fun deserialize(deserializer: Deserializer): SessionCreated {
    ...
    data object MessagesLoaded: Event {
        override fun serialize(serializer: Serializer) {
            serializer.increase_container_depth()
        ...
        fun deserialize(deserializer: Deserializer): MessagesLoaded {
    ...
    data object MessageSent: Event {
        ...
        fun deserialize(deserializer: Deserializer): MessageSent {
            return MessageSent
        }
    }
    ...
    companion object {
        ...
        fun deserialize(deserializer: Deserializer): Event {
            ...
            return when (index) {
                ...
                2 -> Connect.deserialize(deserializer)
                3 -> LoadSessions.deserialize(deserializer)
                4 -> SelectSession.deserialize(deserializer)
                5 -> CreateSession.deserialize(deserializer)
                6 -> SessionCreated.deserialize(deserializer)
                7 -> LoadMessages.deserialize(deserializer)
                8 -> MessagesLoaded.deserialize(deserializer)
                9 -> SendMessage.deserialize(deserializer)
                10 -> MessageSent.deserialize(deserializer)
...
data class ViewModel(
    ...
    companion object {
        fun deserialize(deserializer: Deserializer): ViewModel {
            ...
            deserializer.decrease_container_depth()
            return ViewModel(screen, serverUrl, connected, loading, error, sessions, currentSessionId, messages, draftMessage)
        }
